...
class ODE3system(ExplicitComponent):
    ...
    def setup(self):
        ...
        # output
        self.add_output('dp_ds',shape=(num_nodes,k,3,1))
        ...
        self.declare_partials('dp_ds', 'R_',rows = row_indices, cols = col_indices.flatten())
        self.declare_partials('dp_ds', 'p',val=0)
    ...
    def compute_partials(self, inputs, partials):
        ...
        partials['dp_ds','R_'][:] = Ppd_pr.flatten()
...
if __name__ == '__main__':
    ...
    comp = ODE3system(num_nodes=n,k=k)
