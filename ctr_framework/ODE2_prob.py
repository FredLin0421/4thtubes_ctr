...
class ODE2Problem(ODEProblem):
    def setup(self):
        ...
        self.add_state('R','R_dot', initial_condition_name='R0',shape= (k,3,3))

        # Output Variables
        self.add_field_output('field_output', coefficients_name='coefficients', state_name='R')
        self.add_profile_output('state', state_name='R',shape=(k,3,3))
...
print(prob.get_val('state').shape)
