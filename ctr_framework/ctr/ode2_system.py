...
class ODE2System(ExplicitComponent):
    ...
    def setup(self):
        ...
        # output
        self.add_output('dr_ds',shape=(num_nodes,k,3,3))
        ...
        self.declare_partials('dr_ds', 'R',rows = row_indices, cols = col_indices.flatten())
        ...
        self.declare_partials('dr_ds','uhat', rows= row_indices_h.flatten(), cols = col_indices_h.flatten())
    ...
    def compute_partials(self, inputs, partials):
        ...
        partials['dr_ds','R'][:] = Prd_pr.flatten()
        ...
        partials['dr_ds','uhat'][:] = Prd_ph.flatten()
