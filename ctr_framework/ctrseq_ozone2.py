...
class Ctrseqozone2(om.Group):
    ...
    def setup(self):
        ...
        if i == 9:
            ...
            init_guess = scipy.io.loadmat('seq_r1'+str(i-1)+'.mat')
        ...
        coefs[num_nodes] = 1.
        comp.add_output('coefficients', val=coefs)
        comp.add_output('h', val=np.ones(num_nodes))
        ...
        # 'ODE 1 : kinematics'
        # ode_function1 = CtrFunction(k=1,tube_nbr = tube_nbr)
        ...
        ODE1Problem_instance = ODE1Problem('RK4','time-marching',num_times=num_nodes,\
        ...
        ODE2Problem_instance = ODE2Problem('RK4', 'time-marching',num_times=num_nodes,\
                                                display='default', visualization= None)
        ...
        ODE3Problem_instance = ODE3Problem('RK4', 'time-marching',num_times=num_nodes,\
                                                display='default', visualization= None)
        ode3 = ODE3Problem_instance.create_component()
        self.add_subsystem('integator3', ode3, promotes=['*'])
        ...
        # self.add_design_var('kappa', lower=[0.01,0,0,0],upper=1)
