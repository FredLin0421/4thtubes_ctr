...
from ctr_framework.ODE1_system import ODE1system
...
class ODE1Problem(ODEProblem):
    ...
    def setup(self):
        ...
        self.add_parameter('K_out',shape=(self.num_times,k,tube_nbr,tube_nbr),dynamic=True)
        # ODE variables
        # self.add_state('y','dy_dt', initial_condition_name='y0',shape= (2,1))
        self.add_state('psi','psi_ddot', initial_condition_name='initial_condition_psi',shape= (k,tube_nbr))
        self.add_state('dpsi_ds','psi_dot', initial_condition_name='initial_condition_dpsi',shape= (k,tube_nbr))
